...
# Add parent directory to path to import adi
...
def generate():
    ...
    print(f"Generating docs for {len(device_modules)} device modules...")
...
"""
            ...
            if compat_list:
                ...
                for cname, compat in compat_list:
                    lines.append(f"The class **adi.{cname}** supports the following IIO drivers:")
                    lines.append("")
                    lines.append(f".. autoattribute:: adi.{mod_name}.{cname}.compatible_parts")
                    lines.append("")
            ...
            for cname, cls in main_classes:
                ...
                lines.append(f".. autoclass:: adi.{mod_name}.{cname}\n   :members:\n   :undoc-members:\n   :show-inheritance:{exclude}")
                lines.append("")
            ...
            if channel_classes:
                ...
                for cname, cls in channel_classes:
                    ...
                    lines.append(f"The {base_name} class supports a variable number of channels depending on the hardware configuration. Therefore, the channel property interfaces are dynamically generated. They are available on an initiated object as attributes with names voltage0, voltage1, etc. They will be instances of the {cname} class.")
                    lines.append("")
                    lines.append(f".. autoclass:: adi.{mod_name}.{cname}\n   :members:\n   :undoc-members:\n   :show-inheritance:")
                    lines.append("")
    ...
    print("Generating source/devices/index.rst...")
    index_lines = [
        "Supported Devices",
        "=================",
        "",
