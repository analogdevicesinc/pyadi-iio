...
class ad9910(tx, compatible):
    ...
    class channel(Enum):
        ...
        PARALLEL_AMP = "altvoltage110"
        PARALLEL_PHASE = "altvoltage111"
        PARALLEL_FREQ = "altvoltage112"
        PARALLEL_POLAR = "altvoltage113"
        DRG = "altvoltage120"
    ...
    class parallel_data_port:
        ...
        def frequency_offset(self):
            ...
            return self._dds._get_iio_attr(
                ad9910.channel.PARALLEL_FREQ, "frequency_offset"
            )

        @frequency_offset.setter
        def frequency_offset(self, value):
            self._dds._set_iio_attr(
                ad9910.channel.PARALLEL_FREQ, "frequency_offset", value
            )
        ...
        def frequency_scale(self):
            ...
            """
            return self._dds._get_iio_attr(
                ad9910.channel.PARALLEL_FREQ, "frequency_scale"
            )

        @frequency_scale.setter
        def frequency_scale(self, value):
            self._dds._set_iio_attr(
                ad9910.channel.PARALLEL_FREQ, "frequency_scale", value
            )
        ...
        def phase_offset(self):
            ...
            """
            return self._dds._get_iio_attr(
                ad9910.channel.PARALLEL_POLAR, "phase_offset"
            )

        @phase_offset.setter
        def phase_offset(self, value):
            self._dds._set_iio_attr(
                ad9910.channel.PARALLEL_POLAR, "phase_offset", value
            )
        ...
        def scale_offset(self):
            ...
            """
            return self._dds._get_iio_attr(
                ad9910.channel.PARALLEL_POLAR, "scale_offset"
            )

        @scale_offset.setter
        def scale_offset(self, value):
            self._dds._set_iio_attr(
                ad9910.channel.PARALLEL_POLAR, "scale_offset", value
            )
        ...
        def rate(self, value):
            self._dds._set_iio_attr(
                ad9910.channel.PARALLEL_FREQ, "sampling_frequency", value
            )
        ...
        def frequency_push(self, frequency_np, cyclic=True):
            ...
            freq_np = np.round((frequency_np - freq_min) * hz_to_word / freq_scale)
            self._dds.tx_enabled_channels = [2]
            self.raw_push(freq_np.astype(np.uint16), cyclic)
    ...
    def __init__(self, uri="", device_name=""):
        ...
        self._tx_channel_names = [
            ...
            ad9910.channel.PARALLEL_POLAR.value,
        ]
        tx.__init__(self)
