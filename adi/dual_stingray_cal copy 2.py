...
adc_map      = np.array([3, 1, 0, 2])  # ADC map to subarray # ADC map to subarray (not necessary in Python implementation)
adc_ref      = 3  # ADC reference channel (indexed at 0)
...
#########################################################################
#########################################################################
f_carrier = 10e9 # freq of RF source
...
#Sometimes this crashes if you dont add the sleep 
time.sleep(1)
