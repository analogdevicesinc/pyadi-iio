...
from . import mbx_instrument as equip
from . import dynamixel_functions as dynamixel                     # Uses Dynamixel SDK library
...
def gotoZERO(accuracy="HIGH"):
    ...
    if gim_type == HV:
        ...
        jump_angle(0.00, 0.70, 0, accuracy)
        # jump_angle(-5, 5, 0, accuracy)
        # jump_angle()
