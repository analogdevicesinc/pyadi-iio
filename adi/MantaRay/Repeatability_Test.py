...
for sample_num in range(1, num_samples + 1):
    ...
    sample_iq_dict = {
        ...
        "power_dBm": np.array(sample_powers_64),  # RAW (unnormalized)
    ...
    # Save this sample's power plot (RAW)
...
# Create overlay plot with all samples (RAW)
