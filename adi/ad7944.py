...
class ad7944(rx, context_manager):
    ...
    def __init__(self, uri="ip:analog.local", device_name="ad7944"):
        ...
        # case.
        try:
            self._get_iio_attr(self.rx_channel_names[0], "sampling_frequency_available", False)
    ...
    def sampling_frequency_available(self):
        ...
        if isinstance(self._rx_data_type, np.uint32):
            return self._get_iio_attr(self.rx_channel_names[0], "sampling_frequency_available", False)
        else:
            pass
    ...
    def sampling_frequency(self, rate):
        ...
        self._set_iio_attr(self.rx_channel_names[0], "sampling_frequency", value=rate, output=False)
