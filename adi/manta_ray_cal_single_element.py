...
def create_dict(new_keys, array):
    ...
    reshaped_keys = new_keys.reshape(2, 2,order='F')
    reshaped_array = array.reshape(2, 2,order='F')
...
axs[1].plot(phase_delay_cal_data[:,0].imag,'red')
axs[1].plot(phase_delay_cal_data[:,1].imag,'blue')
axs[1].plot(phase_delay_cal_data[:,2].imag,'green')
axs[1].plot(phase_delay_cal_data[:,3].imag,'orange')
