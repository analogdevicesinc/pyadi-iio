...
# Connect to ADMV1420
# Standalone:
# rx = adi.admv1420(uri="ip:192.168.1.100")
# Neponset board (specify device instance):
rx = adi.admv1420(uri="ip:10.75.161.150", device_name="admv1420_rx_0")
...
# Set LO phase
rx.lo_direct_i_phase_val = 15
rx.lo_direct_q_phase_val = 15
