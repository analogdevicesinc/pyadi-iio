...
from . import ADSY2301 as mr            # ADSY2301 helper module (calibration, capture, etc.)
...
dev = adi.adar1000_array(
    ...
    chip_ids=[
        "adar1000_csb_0_1_2", "adar1000_csb_0_1_1", 
        "adar1000_csb_0_1_3", "adar1000_csb_0_1_4", 
    ],
...
cal_json_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), cal_filename)
...
active_array = np.array(list(range(1, 17)))  # All 16 elements
...
# Turn on the PA drain voltage and enable all 16 bias channels.
