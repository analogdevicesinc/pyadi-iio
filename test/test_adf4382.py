...
@pytest.mark.parametrize(
    ...
    [
        ("altvolt0_output_power", 1, 11, 1, 0, 5),#fix in driver 11 is max
        ("altvolt1_output_power", 1, 11, 1, 0, 5),#fix in driver 11 is max
    ],
)
...
@pytest.mark.parametrize(
    "attr, start, stop, step, tol, repeats",
    [
        ("reference_divider", 1, 63, 1, 0, 1), #fix in driver 0 is not supported
        ("bleed_current", 0, 8191, 100, 0, 1),
    ],
)
