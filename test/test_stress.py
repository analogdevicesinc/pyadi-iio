...
def test_ad9361_stress_context_creation(
    test_stress_context_creation, classname, channel, repeats
):
    test_stress_context_creation(classname, channel, repeats)
...
def test_ad9361_stress_rx_buffer(
    ...
    test_stress_rx_buffer_creation(classname, channel, repeats)
...
def test_ad9361_stress_tx_buffer(
    test_stress_tx_buffer_creation, classname, channel, repeats
):
    test_stress_tx_buffer_creation(classname, channel, repeats)
...
def test_ad9361_stress_rx_buffer_length(
    test_stress_rx_buffer_length, classname, channel, buffer_sizes
):
    test_stress_rx_buffer_length(classname, channel, buffer_sizes)
