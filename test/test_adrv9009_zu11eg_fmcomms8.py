...
@pytest.mark.parametrize(
    ...
    [
        dict(
            ...
            rx_powerdown_chan0_chip_c=1,
            rx_powerdown_chan1_chip_c=1,
            rx_powerdown_chan0_chip_d=1,
            rx_powerdown_chan1_chip_d=1,
            ...
            obs_powerdown_chan0_chip_d=0,
            obs_powerdown_chan1_chip_d=0,
    ...
    [
        (
            dict(
                trx_lo_chip_c=1000000000,
                trx_lo_chip_d=1000000000,
                obs_powerdown_chan0_chip_c=1,
                obs_powerdown_chan1_chip_c=1,
                obs_powerdown_chan0_chip_d=1,
                obs_powerdown_chan1_chip_d=1,
                rx_powerdown_chan0_chip_c=0,
                rx_powerdown_chan1_chip_c=0,
                rx_powerdown_chan0_chip_d=0,
                rx_powerdown_chan1_chip_d=0,
