...
def test_fmcomms5_rx_data(test_dma_rx, classname, hardware, channel):
...
@pytest.mark.parametrize("classname, hardware", [(classname, hardware)])
@pytest.mark.parametrize("channel", [0, 1, [0, 1]])
def test_fmcomms5_tx_data(test_dma_tx, classname, hardware, channel):
...
def test_fmcomms5_loopback(test_dma_loopback, classname, hardware, channel):
...
def test_fmcomms5_sfdr(test_sfdr, classname, hardware, channel, param_set, sfdr_min):
...
def test_fmcomms5_iq_loopback(test_iq_loopback, classname, hardware, channel, param_set):
...
@pytest.mark.parametrize(
    "attr, start, stop, step, tol",
    [
        ("tx_hardwaregain_chip_b", -89.75, 0.0, 0.25, 0),
...
def test_fmcomms5_chip_b_rx_data(test_dma_rx, classname, hardware, channel):
    test_dma_rx(classname, hardware, channel)
...
@pytest.mark.parametrize("classname, hardware", [(classname, hardware)])
@pytest.mark.parametrize("channel", [2, 3, [2, 3]])
def test_fmcomms5_chip_b_tx_data(test_dma_tx, classname, hardware, channel):
    test_dma_tx(classname, hardware, channel)
...
def test_fmcomms5_chip_b_loopback(test_dma_loopback, classname, hardware, channel):
    test_dma_loopback(classname, hardware, channel)
...
@pytest.mark.parametrize("sfdr_min", [40])
def test_fmcomms5_chip_b_sfdr(test_sfdr, classname, hardware, channel, param_set, sfdr_min):
    test_sfdr(classname, hardware, channel, param_set, sfdr_min)
...
def test_fmcomms5_chip_b_iq_loopback(test_iq_loopback, classname, hardware, channel, param_set):
    test_iq_loopback(classname, hardware, channel, param_set)
