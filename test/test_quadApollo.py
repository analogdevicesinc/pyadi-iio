...
# Hardware: ADXBAND16EBZ (quadApollo)
...
def test_quadApollo_dds_loopback(
    test_dds_loopback,
    iio_uri,
    classname,
    param_set,
...
def test_quadApollo_sfdr(test_sfdr, iio_uri, classname, channel, param_set, sfdr_min, hpf_value, lpf_value):
...
def test_quadApollo_NSD(test_nsd, iio_uri, classname, channel, param_set, nsd_min, frequency):
