...
@pytest.mark.parametrize(
    ...
    [
        (params["filter_test_1"], 10000000, 0.75, -30, 5, 15),
        (params["filter_test_2"], 10000000, 0.75, -50, 11, 9),
        (params["dac_adc_loopback_0dB_attenuation"], 10000000, 0.75, -30, 5, 15),
        (params["dac_adc_loopback_30dB_attenuation"], 10000000, 0.75, -60, 5, 15),
    ],
)
