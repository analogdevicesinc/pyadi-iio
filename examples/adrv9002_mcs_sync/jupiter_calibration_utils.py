...
def do_cal_gain(sdrs):
    ...
    # Calculate the calibration coefficients between the amplitude on the channel with max amplitude and other channels
    ...
    print("Gain calibration coefficients: " + str(amplitude_cal_coeff))
    sdrs.save_gain_cal()
    sdrs.load_gain_cal()
...
def do_cal_phase(sdrs):
    ...
    # Calculate phase difference between rx0 - rx1; rx0 - rx2; rx0 - rx3:
