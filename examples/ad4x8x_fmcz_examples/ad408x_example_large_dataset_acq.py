...
from ad4x8x_eval_fmcz_config import config_ad408x, filter_bw_lookup, run_script, copy_script_file
...
# my_acq_size = 30 * 1024 * 1024 # 512  # For pyadi-iio Max 30M samples
my_acq_size = 80 * 1024 * 1024  # For remote_script, Max 80M samples for RAM driver ad408x exampleii
...
# drivers of the Zedboard
    ...
    try:
        print('Open SSH...')
        # Connect to the Linux PC
        ssh.connect(hostname_remote, port, username, password, timeout=10)
        print('SSH connection successful!')
...
if config_mode == 'FILE':
    ...
    #
    adc_chs = 1
    genalyzer_data_analysis(data, fsamp, noise_bw, odr, 10e3, adc_bits, (2 * adc_vref), adc_chs, do_plots,
                            do_histograms)
