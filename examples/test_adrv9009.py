...
class dmesg():
    def __init__(self, address):
        if "ip:" in address:
            address = address[3:]
        self.c = Connection(address, user="root",
...
class debug_adrv9009_zu11eg_fmcomms8():
    ...
    def get_flat_read_regs(self, suffix = ""):
        return { "clock_chip_carrier_5a" : fmcomms8._clock_chip_carrier.reg_read(0x5A),
...
if __name__ == "__main__":
    ...
    debug = debug_adrv9009_zu11eg_fmcomms8(fmcomms8, jesd = fmcomms8_jesd, dmesg = fmcomms8_dmesg)
