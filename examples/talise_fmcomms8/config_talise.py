...
lo_freq = 5044000000 - 245760 # lo frequency of talise
...
used_rx_channels = 8
rx_channels_used = [0, 1, 2, 3, 4, 5, 6, 7]
for i in range(used_rx_channels):
    if(used_rx_channels <= 8):
...
num_samps = int((10*sample_rate)/tx_sine_baseband_freq) #int((20*sample_rate)/tx_sine_baseband_freq) # number of samples per call to rx()
