...
# Phase and desync relative to channel A — Method 1: FFT phase (sub-sample)
...
print(f"\n{'Ch':>3}  {'phase (deg)':>12}  {'offset vs A (deg)':>18}  {'FFT desync (samp)':>18}  {'FFT desync (ns)':>15}")
for i, (label, ph) in enumerate(zip(labels, phases)):
    ...
    print(
        f"{label:>3}  {ph:>12.2f}  {offset_deg:>18.2f}  {desync_samples:>18.4f}  {desync_ns:>15.3f}"
    )
