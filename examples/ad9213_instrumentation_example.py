...
stdout, stderr = ssh._run(f"busybox devmem 0x7c450088 32 ")
print(f"0x88 is: {stdout}")
stdout, stderr = ssh._run(f"busybox devmem 0x7c450088 32 0x2")
stdout, stderr = ssh._run(f"busybox devmem 0x7c450088 32 ")
print(f"0x88 is: {stdout}")
stdout, stderr = ssh._run(f"busybox devmem 0x44A30010 32 ")
print(f"0x10 is: {stdout}")



stdout, stderr = ssh._run(f"busybox devmem 0x7c450104 32 ")
print(f"0x104 is: {stdout}")
stdout, stderr = ssh._run(f"busybox devmem 0x7c450104 32 0x1")
