...
ad3552r_0 = adi.ad3552r_hs(uri=my_uri, device_name="dac0")
ad3552r_1 = adi.ad3552r_hs(uri=my_uri, device_name="dac1")
...
ad3552r_0._tx_data_type=np.uint16
ad3552r_1._tx_data_type=np.uint16


# signal generation
fs = int(ad3552r_0.channel[0].sample_rate)
# Signal frequency
fc = 80000
# Number of samples
N = int(fs / fc)
...
# tx
print("Sampling rate is:", ad3552r_0.channel[0].sample_rate)
...
ad3552r_0.input_source = "normal"
ad3552r_1.input_source = "normal"
